...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'TestBundle\\testBundle\\Controller\\loginController::userAction',  '_route' => 'login_homepage',);
        }

        // signup
        if ($pathinfo === '/signup') {
            return array (  '_controller' => 'TestBundle\\testBundle\\Controller\\loginController::signupAction',  '_route' => 'signup',);
        }
